...
export function getPositionCurve(): THREE.CatmullRomCurve3 {
  const points = [
    new THREE.Vector3(0.2, 0.7, 2.5),                               // 1
    new THREE.Vector3(0.2, 0.7, 2.3),                               // 1
    new THREE.Vector3(0.18, 0.47, 1.2),       // 2: Dormitorio centro
    new THREE.Vector3(-1.29, 0.88, 0.84),     // 3: Sala con puertas de cristal
    // new THREE.Vector3(0.27, 0.59, 0.26),     // 4: Baño, vista bañera/vanity
    new THREE.Vector3(-0.70, 0.65, 0.20),       // 5: Vista baja hacia exterior
    ...
    new THREE.Vector3(1.35, 0.66, -0.62),      // 8: Baño vanity y exterior
  ];
...
export function getTargetCurve(): THREE.CatmullRomCurve3 {
  const points = [
    new THREE.Vector3(0.2, 0.7, 0),               // 1: Cama y estantería
    new THREE.Vector3(0.2, 0.7, 0),               // 1: Cama y estantería
    new THREE.Vector3(4.36, 0.56, 3.93),      // 2: Cama y pared fondo
    new THREE.Vector3(3.35, -0.06, -0.77),    // 3: Exterior patio/árboles
    // new THREE.Vector3(5.45, 0.32, -3.72),      // 4: Bañera, vanity, ventana
    new THREE.Vector3(2.85, 0.15, -3.0), 
